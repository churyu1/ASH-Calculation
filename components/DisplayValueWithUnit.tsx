...
const DisplayValueWithUnit: React.FC<DisplayValueWithUnitProps> = ({ value, unitType, unitSystem, valueClassName = '', tooltipContent }) => {
    const { t } = useLanguage();
    ...
    const mainDisplay = (
        <div className="flex items-center justify-end gap-1">
            <span className={`${valueClassName} font-bold`}>{formatNumber(displayValue)}</span>
