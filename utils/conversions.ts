...
const UNIT_CONVERSIONS = {
    ...
    toImperial: {
        ...
        enthalpy: (kjkgDA: number) => kjkgDA * 0.429923 + 7.68, // kJ/kg(DA) to BTU/lb(DA) with 0°F ref offset
    ...
    toSI: {
        ...
        enthalpy: (btu_lbDA: number) => (btu_lbDA - 7.68) / 0.429923, // BTU/lb(DA) to kJ/kg(DA) with 0°F ref offset
